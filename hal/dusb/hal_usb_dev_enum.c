...
#define __CONFIG_UVC_SIZE__	 (0x16b  - 0x7A + 0x6B)//(0x16b + 0x6b)
...
#define __CONFIG_COMB3_SIZE__	(0x16b - 0x7A /*+ 0x6B*/ + 0x17)//(0x16b + 0x6b+ 0x17)
...
//==uvc desc==
u8 const UsbStrDescProduct_1[0x26] =
{
	0x26,				// Num bytes of this descriptor
	0x03,			// String Descriptor
	'D',	0,
	'i',	0,
	'g',	0,
