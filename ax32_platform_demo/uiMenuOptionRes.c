...
static widgetCreateInfor menuOptionWin[] =
	{
		createFrameWin(Rx(50), Ry(55), Rw(220), Rh(/*176*/ 120), /*R_COLOR_BLACK*/ R_COLOR_TBLACK, WIN_ABS_POS),
		...
		createItemManage(OPTION_SELECT_ID, Rx(0), Ry(/*34*/ 0), Rw(220), Rh(/*142*/ 120), /*INVALID_COLOR*/ R_COLOR_TBLACK),
		widgetEnd(),
};
