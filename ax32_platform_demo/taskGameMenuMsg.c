...
static u8 *rgb24_buf;
static u32 game_bmp_id[GAME_NUM] = {RES_GAMEMENU_BOLL, RES_GAMEMENU_PUSHBOX, RES_GAMEMENU_RB, RES_GAMEMENU_SNAKE, RES_GAMEMENU_PLANE, RES_GAMEMENU_MAZE};
static u8 game_idx;
...
static int gameMenuKeyMsgOk(winHandle handle, uint32 parameNum, uint32 *parame)
{
	...
	msgGameFunc gameList[] = {game_block_entry, game_sokoban_entry, game_tetris_entry, game_snake_entry, /*game_snake_entry*/ game_plane_entry, game_maze_entry};
...
msgDealInfor gameMenuMsgDeal[] =
	{
		...
		{KEY_EVENT_MODE, gameMenuKeyMsgUp},
		{KEY_EVENT_MENU, gameMenuKeyMsgDown},
		//	{KEY_EVENT_MENU,gameMenuKeyMsgMenu},
		{KEY_EVENT_OK, gameMenuKeyMsgOk},
		{KEY_EVENT_POWER, gameMenuKeyMsgExit},
