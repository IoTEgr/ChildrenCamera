...
#define  MEDIA_CFG_AUDIO_PLAYBK_EN     1    // audio playback
#define  MEDIA_CFG_AUDIO_RECORD_EN     0    // audio record
#define  MEDIA_CFG_THUMBNAIL_EN        0    // thumbnail.NOTES: MEDIA_CFG_VIDEO_PLAYBK_EN must en enabled
