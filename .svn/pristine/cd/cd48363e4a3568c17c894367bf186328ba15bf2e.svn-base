...
MENU_OPTION_START(pfastview)//--------photo fast view
...
MENU_OPTION_START(format)//--------
MENU_OPTION_STR(R_ID_STR_COM_OK)
MENU_OPTION_STR(R_ID_STR_COM_CANCEL)
MENU_OPTION_END()

MENU_OPTION_START(defaul)//--------
MENU_OPTION_STR(R_ID_STR_COM_OK)
MENU_OPTION_STR(R_ID_STR_COM_CANCEL)
MENU_OPTION_END()
...
MENU_OPTION_STR(R_ID_STR_COM_LEVEL_8)
MENU_OPTION_END()

MENU_OPTION_START(volume)//--------
MENU_OPTION_STR(R_ID_STR_COM_LEVEL_1)
MENU_OPTION_STR(R_ID_STR_COM_LEVEL_2)
MENU_OPTION_STR(R_ID_STR_COM_LEVEL_3)
MENU_OPTION_STR(R_ID_STR_COM_LEVEL_4)
...
MENU_ITEM_OPTIONS(photoResolution,CONFIG_ID_PRESLUTION,/*R_ID_ICON_MENUIMAGEQ*/NULL,R_ID_STR_SET_QUALITY)
MENU_ITEM_OPTIONS(timephoto,CONFIG_ID_TIMEPHOTO,/*R_ID_ICON_MENUCLOCK*/NULL,R_ID_STR_SET_TIMEPHOTO)
MENU_ITEM_OPTIONS(vidResolution,CONFIG_ID_RESOLUTION,/*R_ID_ICON_MENURESOLUTION*/NULL,R_ID_STR_SET_VIDEO_RESOLUTION)
MENU_ITEM_OPTIONS(loopRecord,CONFIG_ID_LOOPTIME,/*R_ID_ICON_MENULOOPRECORD*/NULL,R_ID_STR_SET_LOOPRECORD)
MENU_ITEM_OPTIONS(timeStamp,CONFIG_ID_TIMESTAMP,/*R_ID_ICON_MENUSTRAMP*/NULL,R_ID_STR_SET_TIMESTRAMP)
MENU_ITEM_OPTIONS(language,CONFIG_ID_LANGUAGE,/*R_ID_ICON_MENULANGUAGE*/NULL,R_ID_STR_SET_LANGUAGE)
MENU_ITEM_OPTIONS(lcdbright,CONFIG_ID_LCD_BRIGHT,/*R_ID_ICON_MENULANGUAGE*/NULL,R_ID_STR_COM_LCD_BRIGHTNESS)
MENU_ITEM_OPTIONS(autoPowerOff,CONFIG_ID_AUTOOFF,/*R_ID_ICON_MENUPOWEROFF*/NULL,R_ID_STR_SET_AUTOOFF)
MENU_ITEM_OPTIONS(screenSave,CONFIG_ID_SCREENSAVE,/*R_ID_ICON_MENUSCRENNOFF*/NULL,R_ID_STR_SET_SCREEN_SAVERS)
MENU_ITEM_OPTIONS(volume,CONFIG_ID_VOLUME,/*R_ID_ICON_MENUSCRENNOFF*/NULL,R_ID_STR_SET_VOLUME)
MENU_ITEM_OPTIONS(format,CONFIG_ID_FORMAT,/*R_ID_ICON_MENULANGUAGE*/NULL,R_ID_STR_SET_FORMAT)
MENU_ITEM_PROC(menuProcDateTime,/*R_ID_ICON_MENUCLOCK*/NULL,R_ID_STR_SET_DATETIME)
MENU_ITEM_OPTIONS(defaul,CONFIG_ID_DEFUALT,/*R_ID_ICON_MENULANGUAGE*/NULL,R_ID_STR_SET_DEFAULT_SETTING)
MENU_ITEM_PROC(menuProcVersion,/*R_ID_ICON_MENUVERSION*/NULL,R_ID_STR_SET_VERSION)

//MENU_ITEM_OPTIONS(pfastview,CONFIG_ID_PFASTVIEW,R_ID_ICON_MENUPFASTVIEW,R_ID_STR_SET_FASTVIEW)
...
//MENU_ITEM_OPTIONS(keySound,CONFIG_ID_KEYSOUND,/*R_ID_ICON_MENUAUDIO*/NULL,R_ID_STR_SET_BEEPSOUND)
...
MENU_PAGE_ITEMS(movie,/*R_ID_ICON_MTMENU*/NULL,/*R_ID_ICON_MTMENU*/NULL,R_ID_STR_SET_VIDEO)
